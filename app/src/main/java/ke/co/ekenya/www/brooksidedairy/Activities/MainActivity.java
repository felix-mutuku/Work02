...
import ke.co.ekenya.www.brooksidedairy.Fragments.DashboardFragment;
import ke.co.ekenya.www.brooksidedairy.Fragments.MainMenuFragment;
import ke.co.ekenya.www.brooksidedairy.R;

public class MainActivity extends AppCompatActivity {

    LinearLayout nav_menu, nav_web_portal, nav_help, nav_logout;
    DrawerLayout drawer;
    FrameLayout app_content;
